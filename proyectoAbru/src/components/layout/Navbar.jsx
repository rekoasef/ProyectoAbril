...
const Navbar = () => {
  ...
  // Estilos para NavLink activo e inactivo
  ...
  return (
    <nav className="bg-white-off shadow-soft sticky top-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20"> {/* Aumenté un poco la altura */}
          {/* Logo */}
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-white-off shadow-lg z-40 border-t border-beige-light" id="mobile-menu"> {/* Agregué absolute y top-full */}
